...
public class EshoritoriGridGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gridSizeWidth = EshiritoriDrawingManager.instance.CanvasWidth * gridSize;
        gridSizeHeight = EshiritoriDrawingManager.instance.CanvasHeight * gridSize;
    ...
    private void CreateGrid(int width, int height)
    {
        ...
        if (EshiritoriDrawingManager.instance.CanvasWidth > 10 || EshiritoriDrawingManager.instance.CanvasHeight > 10)
        {
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
        ...
        if (EshiritoriDrawingManager.instance.CanvasWidth > 20 || EshiritoriDrawingManager.instance.CanvasHeight > 20)
        {
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
        ...
        if (EshiritoriDrawingManager.instance.CanvasWidth > 30 || EshiritoriDrawingManager.instance.CanvasHeight > 30)
        {
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
        ...
        if (EshiritoriDrawingManager.instance.CanvasWidth > 40 || EshiritoriDrawingManager.instance.CanvasHeight > 40)
        {
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
