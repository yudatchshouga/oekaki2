...
using static DengonDrawingManager;

public class DengonPreviewGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        int previewWidth = DengonDrawingManager.instance.CanvasWidth;
        int previewHeight = DengonDrawingManager.instance.CanvasHeight;
    ...
    private void Update()
    {
        ...
        previewColor = DengonDrawingManager.instance.drawColor;
        previewBrushSize = DengonDrawingManager.instance.brushSize;
        currentPreviewMode = DengonDrawingManager.instance.currentMode;
