...
public class CooperatePreviewGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        int previewWidth = CooperateDrawingManager.instance.CanvasWidth;
        int previewHeight = CooperateDrawingManager.instance.CanvasHeight;
    ...
    private void Update()
    {
        ...
        previewColor = CooperateDrawingManager.instance.drawColor;
        previewBrushSize = CooperateDrawingManager.instance.brushSize;
        currentPreviewMode = CooperateDrawingManager.instance.currentMode;
